 ...
 * Description :
 * Created by dabutaizha on 2018/7/26 下午6:10.
 */

public class SecondActivity extends AppCompatActivity implements SlideEventListener {
    ...
    private void initData() {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            map.put("content", "这是第二个Activity ﾍ(ﾟ∀ﾟﾍ)ｱﾋｬ");
            mData.add(map);
        }
